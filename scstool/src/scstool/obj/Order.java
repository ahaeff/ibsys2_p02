...
public class Order {
	...
	public void setMode(Integer mode) {
		// if(mode.length() > 1) throw new
		// InvalidParameterException("Parameter must be p, e or k");
	...
	public String toString() {
		return "Order [id=" + id + ", amount=" + amount + ", finished="
				+ finished + ", mode=" + mode + ", ordercosts=" + ordercosts
				+ ", piececosts=" + piececosts + ", entirecosts=" + entirecosts
				+ ", material=" + material + "]";
	}
	...
	/**
	 * orderperiod (in welcher Periode kommt der Artikel) mode (bestelltyp,
	 * Eil/Normal) article (material) amount (menge) time (zeitstempel -->
	 * Wochentag) -->Lieferdatum materialcosts (kosten f���r das Material)
	 * ordercosts (bestellkosten) entirecosts (bestellkosten gesamt) piececosts
	 * (st���ckkosten) -----------------------------------------------------
	 * Lieferdatum --> time bestelldatum --> not menge --> amount beendet -->
	 * not bestellart --> mode Artikel_ID --> article
	 * 
	 */
